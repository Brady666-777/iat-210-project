...
const factions = [
  {
    ...
    cards: [
      { name: 'Hierarchy Fleet Ship', type: 'Ship Miniature', desc: 'Blue metallic board piece — angular Turian hull design.' },
      { name: 'Tactical Discipline Token', type: 'Ability Token', desc: 'Fuel cost reduction tracker for movement.' },
      { name: 'Covering Fire Card', type: 'Race Card', desc: 'Spend 1 Fuel — gain +2 die roll this turn.' },
      { name: 'Turian Race Board', type: 'Race Board', desc: '10-slot Ark track: Metal-heavy early, mixed late game.' },
    ],
  },
  {
    id: 'asari',
    ...
    cards: [
      { name: 'Thessia Ark Design', type: 'Ship Miniature', desc: 'Purple crystalline board piece — curved Asari hull.' },
      { name: 'Biotic Resonance Token', type: 'Ability Token', desc: 'Draw-2-keep-1 tracker for Action Cards.' },
      { name: 'Enthrall Card', type: 'Race Card', desc: 'Spend 1 Crystal — force a 1-for-1 resource swap with any player.' },
      { name: 'Asari Race Board', type: 'Race Board', desc: '10-slot Ark track: Crystal-dominant throughout.' },
    ],
  },
  {
    id: 'krogan',
    ...
    cards: [
      { name: 'Tuchanka War Ark', type: 'Ship Miniature', desc: 'Orange armored board piece — brutalist Krogan hull.' },
      { name: 'Blood Rage Token', type: 'Ability Token', desc: 'Sabotage negation tracker (1 Fuel per use).' },
      { name: 'Hardcore Charge Card', type: 'Race Card', desc: 'Spend 2 Fuel — teleport to any unoccupied space.' },
      { name: 'Krogan Race Board', type: 'Race Board', desc: '10-slot Ark track: Extremely Metal-heavy, highest total cost.' },
    ],
  },
  {
    id: 'salarian',
    ...
    cards: [
      { name: 'Sur\'Kesh Ark Module', type: 'Ship Miniature', desc: 'Teal sleek board piece — Salarian organic hull.' },
      { name: 'Research Acceleration Token', type: 'Ability Token', desc: '+1 Crystal at start of every turn.' },
      { name: 'Intel Analysis Card', type: 'Race Card', desc: 'Spend 1 Crystal — look at top 3 Sabotage Cards; reorder or draw 1.' },
      { name: 'Salarian Race Board', type: 'Race Board', desc: '10-slot Ark track: Crystal-heavy with late-game complexity.' },
    ],
  },
  {
    id: 'human',
    ...
    cards: [
      { name: 'SSV Alliance Ark', type: 'Ship Miniature', desc: 'Gold board piece — Alliance Systems Navy hull design.' },
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="p-6 grid sm:grid-cols-2 md:grid-cols-4 gap-4">
            {active.cards.map(({ name, type, desc }) => (
              <div
                key={name}
